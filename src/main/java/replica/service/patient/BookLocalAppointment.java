...
@XmlRootElement(name = "bookLocalAppointment", namespace = "http://endpoint.replica/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "bookLocalAppointment", namespace = "http://endpoint.replica/", propOrder = {
    "arg0",
    "arg1",
    "arg2"
})
public class BookLocalAppointment {
